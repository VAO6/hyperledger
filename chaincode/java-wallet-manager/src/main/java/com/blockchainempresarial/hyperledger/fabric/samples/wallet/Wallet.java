...
public final class Wallet {
	...
	public boolean equals(final Object obj) {
		...
		return Object.deepEquals (new String [] { getTokenAmount().toString(), getOwner() },
	...
	public String toString() {
		return this.getClass().getSimpleName() + "@" + Integer.toHexString(hashCode()) + " [tokenAmount=" + tokenAmount + ", owner=" + owner + "]";
	}
}
