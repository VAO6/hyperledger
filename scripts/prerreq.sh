...
echo "####################################################### "
brew install openjdk-8-jre-headless
...
echo 'export M2_HOME=/opt/apache-maven' >> ~/.bash_profile
...
echo 'export PATH=$PATH:$HOME/hyperledger/fabric/fabric-samples/bin' >> ~/.bash_profile
source ~/.bash_profile